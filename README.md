...
**사전 요구사항:** Node.js 20+, pnpm 9+, PostgreSQL (로컬 설치 또는 Docker)
...
# .env.local에서 DATABASE_URL을 PostgreSQL 연결 문자열로 수정
# 예: DATABASE_URL="postgresql://user:password@localhost:5432/cost_accounting"
